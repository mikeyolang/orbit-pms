...
export function AuthShell({
  ...
  return (
    <div className="relative flex min-h-screen flex-col overflow-hidden bg-slate-50 dark:bg-slate-950">
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_top_left,rgba(27,54,115,0.12),transparent_35%),radial-gradient(circle_at_bottom_right,rgba(27,54,115,0.10),transparent_35%)]" />
      ...
      <main className="relative flex flex-1 items-center justify-center px-6 py-12">
        <div className="w-full max-w-md rounded-2xl border border-slate-200 bg-white p-7 shadow-xl shadow-slate-900/5 dark:border-slate-800 dark:bg-slate-900 sm:p-9">
          <div className="mb-7 text-center">
            <div className="mx-auto mb-4 h-1 w-12 rounded-full bg-[#1B3673]" />
